...
module.exports = function(sqlBuilder){
	/**
	 * @name $eq
	 * @summary Querying where column is equal to a value
	 * @memberOf Comparison
	 * @isquerying true
	 * @ansi true
	 *
	...
	/**
	 * @name $ne
	 * @summary Querying where column is not equal to a value
	 * @memberOf Comparison
	 * @isquerying true
	 * @ansi true
	 *
	...
	/**
	 * @name $gt
	 * @summary Querying where column is greater than a value
	 * @memberOf Comparison
	 * @isquerying true
	 * @ansi true
	 *
